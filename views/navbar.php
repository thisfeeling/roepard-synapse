...
$cashierIn = ($role_id === 4);     // Asumiendo que 4 es para cajero
$cookIn = ($role_id === 5);        // Asumiendo que 5 es para cocinero
$waiterIn = ($role_id === 6);      // Asumiendo que 6 es para mesero
?>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <a class="navbar-brand" href="../index.php">
                            <img src="../uploads/symphony_synapse_logo.svg" alt="" width="50" height="50">
                        </a>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../index.php">Symphony Synapse</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <?php elseif ($cashierIn): ?>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="../views/user-panel.php">Cashier Panel</a>
                            </li>
                        <?php elseif ($cookIn): ?>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="../views/user-panel.php">Kitchen Panel</a>
                            </li>
                        <?php elseif ($waiterIn): ?>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="../views/user-panel.php">Waiter Panel</a>
                            </li>
                            <li class="nav-item">
