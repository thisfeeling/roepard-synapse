...
if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true) {
    ...
    $stmt = $db->prepare("SELECT profile_picture, first_name, last_name, email, phone, username, country, city, birthdate, bio, website, role_id, status_id FROM users WHERE user_id = :user_id");
...
<body style="background-color: var(--olive-green) !important; color: var(--soft-green);">
    ...
    <main class="container my-5">
                    ...
                    <form id="formUsuario">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="modalUserWebsite" class="form-label">Website</label>
                                    <input type="text" class="form-control" id="modalUserWebsite" name="website" placeholder="Enter a website" required autocomplete="off" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="modalUserBio" class="form-label">Bio</label>
                                    <input type="text" class="form-control" id="modalUserBio" name="bio" placeholder="Enter a bio" required autocomplete="off" />
                                </div>
                            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <!-- Card del usuario -->
                <div class="card text-center shadow-lg" style="background-color: var(--soft-green) !important; color: var(--dark-green) !important;">
                    <div class="card-header bg-white text-dark" style="background-color: var(--soft-green) !important; color: var(--dark-green) !important;">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <!-- Imagen de perfil -->
                            <div class="col-md-4">
                                <img src="../uploads/<?php echo htmlspecialchars($profile_picture); ?>" alt="Profile picture" class="rounded-circle img-fluid mb-3" style="max-width: 150px;">
                            </div>
                    ...
                    <div class="card-footer bg-light" style="background-color: var(--soft-green) !important; color: var(--dark-green) !important;">
